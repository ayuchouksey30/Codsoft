...
root = Tk()  # This creates a basic window
root.geometry("312x324")  # This sets the size of the window
root.resizable(0, 0)  # This prevents resizing the window
...
# Create another frame for the buttons below the input field
